public class SimpleQueue {
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //changed the isnert line here to add
    }
    ...
    private int Dequeue() {
        ...
        var value = _queue[0]; //CHANGED THE INDEX HERE FROM 1 TO 0 
        _queue.RemoveAt(0);    //CHANGED THE INDEX HERE FROM 1 TO 0 
        return value;
    }
}